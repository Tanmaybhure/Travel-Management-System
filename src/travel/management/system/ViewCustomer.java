...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    public ViewCustomer(String name){
        
        //setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(380, 100, 950, 680);
		...
		table = new JTable();
		table.setBounds(0, 40, 950, 350);
		contentPane.add(table);
                
                 try{
                    Conn c = new Conn();
                        String displayCustomersql = "select * from customer where name='"+name+"'";
...
//		});
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==btnNewButton) setVisible(false);
    }
